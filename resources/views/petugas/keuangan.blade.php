...
<head>
    ...
    <title>Inpiksi - Keuangan Dashboard</title>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="#">Bidang Keuangan</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Barang Keuangan</h6>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Daftar Barang Keuangan</h4>
                                <div class="table-responsive">
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                            @php
                                                $barangKeuangan = \App\Models\Barang::where('bidang_id', auth()->user()->bidang_id)
                                                    ->with('kategori','lokasi')->latest()->take(5)->get();
                                            @endphp
                                            @forelse($barangKeuangan as $item)
                                            <tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 activity">
                                    @php
                                        $peminjamans = \App\Models\Peminjaman::whereHas('barang', function ($q) {
                                            $q->where('bidang_id', auth()->user()->bidang_id);
                                        })->latest()->take(4)->get();
                                    @endphp
