...
<head>
    ...
    <title>Inpiksi - Akademik Dashboard</title>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="#">Bidang Akademik</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Barang Akademik</h6>
                                </div>
                    ...
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ \App\Models\Peminjaman::whereHas('barang', function ($q) {
                                    ...
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-dark mb-1 font-weight-medium">
                                            {{ \App\Models\Pengembalian::whereHas('peminjaman', function($q) {
                                                $q->whereHas('barang', function ($qq) {
                                                $qq->where('bidang_id', auth()->user()->bidang_id);
                                            });
                                            })->count() }}
                                        </h2>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Daftar Barang Akademik</h4>
                                <div class="table-responsive">
                                    <table class="table no-wrap v-middle mb-0">
                                        ...
                                        <tbody>
                                            @php
                                                $barangAkademik = \App\Models\Barang::where('bidang_id', auth()->user()->bidang_id)
                                                    ->with('kategori','lokasi')->latest()->take(5)->get();
                                            @endphp
                                            @forelse($barangAkademik as $item)
                                            <tr>
                            ...
                            <div class="card-body">
                                ...
                                @php
                                    $barangAlert = \App\Models\Barang::where('bidang_id', auth()->user()->bidang_id)
                                        ->where(function ($q) {
                                            ...
                                            ->orWhere('kondisi', 'perlu_perbaikan');
                                        })
                                        ->take(3)
                                        ->get();
                                @endphp
                                ...
                                <div class="d-flex align-items-center pb-3 border-bottom">
                                    <div class="mr-3">
                                        ...
                                        class="{{ $alert->kondisi == 'rusak' ? 'text-danger' : ($alert->kondisi == 'perlu_perbaikan' ? 'text-warning' : 'text-muted') }}">
                                        </i>
                                    </div>
                                    <div>
                                        <h6 class="mb-0">{{ $alert->nama_barang }}</h6>

                                        @if($alert->kondisi == 'rusak')
                                            <small class="text-danger">Rusak</small>
                                        @elseif($alert->kondisi == 'perlu_perbaikan')
                                ...
                                @empty
                                <p class="text-muted">Semua barang aman </p>
                                @endforelse
