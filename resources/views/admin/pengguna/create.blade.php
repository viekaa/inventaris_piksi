            ...
            <div class="card custom-card-petugas">
                <div class="card-body p-4">
                    ...
                    <div class="form-header-petugas">
                        <div>
                            <h4 class="form-title-petugas">Tambah Pengguna Baru</h4>
                            <p class="form-subtitle-petugas">Isi form di bawah untuk menambahkan pengguna</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('admin.petugas.store') }}" method="POST">
                        ...
                        <div class="form-content-petugas">
                            ...
                            <div class="form-group-petugas">
                                ...
                                <div class="input-password-wrapper-petugas">
                                    <input
                                        type="password"
                                        name="password"
                                        id="passwordPetugas"
                                        class="form-control-petugas @error('password') is-invalid-petugas @enderror"
                                        placeholder="Minimal 8 karakter"
                                        required
                                    >
                                    <button type="button" class="toggle-password-petugas" onclick="togglePasswordPetugas()">
                                        <i class="fas fa-eye" id="eyeIconPetugas"></i>
                                    </button>
                                </div>
                                @error('password')
                                    <div class="error-message-petugas">
                                ...
                                @enderror
                                <small class="form-hint-petugas">Minimal 8 karakter</small>
                            </div>
...
/* Password wrapper */
.input-password-wrapper-petugas {
    position: relative;
}

.input-password-wrapper-petugas .form-control-petugas {
    padding-right: 50px;
}

.toggle-password-petugas {
    position: absolute;
    top: 50%;
    right: 16px;
    ...
    border: none;
    cursor: pointer;
    color: var(--color-gray-400-petugas);
    padding: 0;
    transition: color 0.2s;
}

.toggle-password-petugas:hover { color: var(--color-primary-petugas); }
...
<script>
function togglePasswordPetugas() {
    const input = document.getElementById('passwordPetugas');
    const icon  = document.getElementById('eyeIconPetugas');
